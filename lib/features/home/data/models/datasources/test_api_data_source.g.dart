...
part of 'test_api_data_source.dart';
...
class _TestApiDataSource implements TestApiDataSource {
  ...
  Future<ApiResponse<TestContentResponse>> getTestContent(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<TestContentResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<TestContentResponse> _value;
    try {
      _value = ApiResponse<TestContentResponse>.fromJson(
        _result.data!,
        (json) => TestContentResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<ApiResponse<TestDetailResponse>> getTestDetail(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<TestDetailResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<TestDetailResponse> _value;
    try {
      _value = ApiResponse<TestDetailResponse>.fromJson(
        _result.data!,
  ...
  Future<ApiResponse<TestsResponse>> getPopularTestsList(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<TestsResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<TestsResponse> _value;
    try {
      _value = ApiResponse<TestsResponse>.fromJson(
        _result.data!,
        (json) => TestsResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
