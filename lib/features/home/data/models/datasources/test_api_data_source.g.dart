...
class _TestApiDataSource implements TestApiDataSource {
  ...
  Future<ApiResponse<TestResultResponse>> getTestResult(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<TestResultResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ApiResponse<TestResultResponse>.fromJson(
      _result.data!,
  ...
  Future<ApiResponse<TestContentResponse>> getTestContent(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<TestContentResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ApiResponse<TestContentResponse>.fromJson(
      _result.data!,
  ...
  Future<ApiResponse<TestsResponse>> getPopularTestsList(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<TestsResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ApiResponse<TestsResponse>.fromJson(
      _result.data!,
