...
class _ProfileApiDataSource implements ProfileApiDataSource {
  ...
  Future<ApiResponse<SetupProfileResponse>> setupProfile(
    ...
    final _data = request;
    final _options = _setStreamType<ApiResponse<SetupProfileResponse>>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    ...
    late ApiResponse<SetupProfileResponse> _value;
    try {
      _value = ApiResponse<SetupProfileResponse>.fromJson(
        _result.data!,
