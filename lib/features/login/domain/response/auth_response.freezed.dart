...
class _$RefreshTokenResponseImpl implements _RefreshTokenResponse {
  ...
  @override
  String toString() {
    return 'RefreshTokenResponse(accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn, tokenType: $tokenType, issuedAt: $issuedAt)';
  }
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, accessToken, refreshToken, expiresIn, tokenType, issuedAt);
...
abstract class _RefreshTokenResponse implements RefreshTokenResponse {
  const factory _RefreshTokenResponse(
      ...
      final int expiresIn,
      final String tokenType,
      final DateTime? issuedAt}) = _$RefreshTokenResponseImpl;
